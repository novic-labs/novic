...
* (cli) [tharsis#1086](https://github.com/novic-labs/novic/pull/1086) Add rollback command.
...
* (rpc) [tharsis#743](https://github.com/novic-labs/novic/pull/743) Fix debug JSON RPC handler crash on non-existing block
