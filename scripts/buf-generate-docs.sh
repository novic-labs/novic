...
# also make sure that you are added to the Novic organization on buf
...
buf mod update $NOVICPROTO

# then, push the novic proto module and documentation
buf push $NOVICPROTO

# two commit addresses should be printed to the command line
# the novic documentation will have links to the third party documentation
