...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/anovic",
			"10",
			sdk.Coin{Denom: "anovic", Amount: sdk.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped anovic coin",
			"anovic",
			"10",
			sdk.Coin{Denom: "anovic", Amount: sdk.NewInt(10)},
		},
		{
			"get ibc wrapped anovic coin",
			"transfer/channel-0/anovic",
			"10",
			sdk.Coin{Denom: teststypes.AnovicIbcdenom, Amount: sdk.NewInt(10)},
		},
		{
