...
```log
ok  	github.com/novic-labs/novic/tests/e2e	174.137s.
```
...
Error:  Received unexpected error:
        ...
        main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc00...
            github.com/novic-labs/novic/cmd/evmosd/root.go:243 +0x2ca
        github.com/novic-labs/novic/server.startInProcess(_, {{0x0, 0x0, 0x0},...
            github.com/novic-labs/novic@v0.20.0-rc2/server/start.go:304 +0x9c5
        github.com/novic-labs/novic/server.StartCmd.func2(0xc001620600?, {0xc0...
            github.com/novic-labs/novic@v0.20.0-rc2/server/start.go:123 +0x1ec
        ...
        main.main()
            github.com/novic-labs/novic/cmd/evmosd/main.go:20 +0x45
