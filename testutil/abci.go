...
import (
	...
	"github.com/novic-labs/novic/v2/testutil/tx"
)
...
//  3. EndBlock
//  4. Commit
func Commit(ctx sdk.Context, app *app.NovicApp, t time.Duration, vs *tmtypes.ValidatorSet) (sdk.Context, error) {
...
func BroadcastTxBytes(app *app.NovicApp, txEncoder sdk.TxEncoder, tx sdk.Tx) (abci.ResponseDeliverTx, error) {
...
func checkTxBytes(app *app.NovicApp, txEncoder sdk.TxEncoder, tx sdk.Tx) (abci.ResponseCheckTx, error) {
	bz, err := txEncoder(tx)
	if err != nil {
		return abci.ResponseCheckTx{}, err
	}
