...
func PrepareAccountsForDelegationRewards(t *testing.T, ctx sdk.Context, app *app.NovicApp, addr sdk.AccAddress, balance sdkmath.Int, rewards ...sdkmath.Int) (sdk.Context, error) {
