...
import (
	...
	utiltx "github.com/novic-labs/novic/v2/testutil/tx"
	...
	evm "github.com/novic-labs/novic/v2/x/evm/types"
...
func (suite *KeeperTestSuite) SetupIBCTest() {
	...
	s.app = suite.EvmosChain.App.(*app.NovicApp)
