...
const (
	...
	MainnetChainID = "novic_70009"
	// TestnetChainID defines the Evmos EIP155 chain ID for testnet
	TestnetChainID = "novic_70008"
...
// GetNovicAddressFromBech32 returns the sdk.Account address of given address,
// while also changing bech32 human readable prefix (HRP) to the value set on
// the global sdk.Config (eg: `evmos`).
// The function fails if the provided bech32 address is invalid.
func GetNovicAddressFromBech32(address string) (sdk.AccAddress, error) {
