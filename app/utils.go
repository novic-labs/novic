...
// Setup initializes a new NovicApp. A Nop logger is set in NovicApp.
func Setup(
	isCheckTx bool,
...
func GenesisStateWithValSet(app *NovicApp, genesisState simapp.GenesisState,
...
func SetupTestingApp() (ibctesting.TestingApp, map[string]json.RawMessage) {
	...
	app := NewNovicApp(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, 5, cfg, simtestutil.NewAppOptionsWithFlagHome(DefaultNodeHome))
