...
import (
	...
	evmante "github.com/novic-labs/novic/v2/app/ante/evm"
	...
	"github.com/novic-labs/novic/v2/types"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.app = app.EthSetup(checkTx, func(app *app.NovicApp, genesis simapp.GenesisState) simapp.GenesisState {
